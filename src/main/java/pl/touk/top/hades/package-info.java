 ...
 * Implementations of {@link pl.touk.top.hades.FailoverActivator} are responsible for this. Every HA data source is
 ...
 * For example {@link pl.touk.top.hades.load.LoadFailoverActivator} activates failover when the main data source is
 * overloaded.
 */
