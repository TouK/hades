 ...
 * Implementations of {@link Monitor} are responsible for this. Every HA data source is
 ...
 * For example {@link pl.touk.hades.sql.timemonitoring.SqlTimeBasedMonitorImpl} activates failover when execution time
